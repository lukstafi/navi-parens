...
function testCase(content: string, command: string, mode: string, language: string, debugThis?: boolean | undefined) {
	...
	return async () => {
		...
		const commands = new Map(Object.entries({
			...
			'goToUpScope': () => myExtension.goToOuterScope(textEditor, false, true, false, false),
			'goToDownScope': () => myExtension.goToOuterScope(textEditor, false, false, false, false),
			'selectToUpScope': () => myExtension.goToOuterScope(textEditor, true, true, false, false),
			'selectToDownScope': () => myExtension.goToOuterScope(textEditor, true, false, false, false),
			'goUpScopeOrArg': () => myExtension.goToOuterScope(textEditor, false, true, false, true),
			'goDownScopeOrArg': () => myExtension.goToOuterScope(textEditor, false, false, false, true),
			'selectUpScopeOrArg': () => myExtension.goToOuterScope(textEditor, true, true, false, true),
			'selectDownScopeOrArg': () => myExtension.goToOuterScope(textEditor, true, false, false, true),
			'goToBeginScope': () => myExtension.goToOuterScope(textEditor, false, true, true, false),
			'goToEndScope': () => myExtension.goToOuterScope(textEditor, false, false, true, false),
			'selectToBeginScope': () => myExtension.goToOuterScope(textEditor, true, true, false, false),
			'selectToEndScope': () => myExtension.goToOuterScope(textEditor, true, false, false, false),
			'goBeginScopeOrArg': () => myExtension.goToOuterScope(textEditor, false, true, true, true),
			'goEndScopeOrArg': () => myExtension.goToOuterScope(textEditor, false, false, true, true),
			'selectBeginScopeOrArg': () => myExtension.goToOuterScope(textEditor, true, true, false, true),
			'selectEndScopeOrArg': () => myExtension.goToOuterScope(textEditor, true, false, false, true),
